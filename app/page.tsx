        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-8 py-12 md:py-20 text-center flex flex-col items-center justify-center min-h-[calc(100svh-4rem)] md:min-h-screen">
          ...
          >
            <Image
              ...
              width={220}
              height={96}
              className="opacity-95 w-[180px] md:w-[220px] h-auto"
            />
          </motion.div>
          ...
          <motion.p
            ...
            className="text-sm md:text-base text-cyan-100 tracking-[2px] md:tracking-[3px] uppercase mb-4 md:mb-6 font-semibold drop-shadow-[0_0_10px_rgba(103,232,249,0.45)] px-2"
          >
          ...
          <motion.div
            ...
            className="mx-auto flex w-full max-w-md sm:max-w-none flex-col sm:flex-row items-center justify-center gap-4 mb-8 md:mb-12"
          >
            <motion.a
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              href="#events"
              className="glass-sm w-full sm:w-auto px-8 md:px-10 py-3 md:py-4 rounded-xl border border-cyan-300/70 text-cyan-100 text-sm md:text-base font-bold tracking-[0.08em] uppercase hover:bg-cyan-500/15 hover:shadow-[0_0_24px_rgba(34,211,238,0.28)] transition duration-300 text-center"
            >
              Explore Events
            </motion.a>
          </motion.div>
      ...
      <section id="events" className="relative py-14 md:py-20 px-4 md:px-8 bg-gradient-to-b from-transparent via-slate-950/35 to-transparent">
                ...
                >
                  ...
                  <div className="p-5 md:p-6 flex flex-1 flex-col">
                    <div>
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <span className="text-cyan-300 group-hover:scale-110 transition duration-300">
                          {renderIcon(event.icon, "h-8 w-8 md:h-10 md:w-10")}
                        </span>
                        <span className="max-w-[62%] px-3 py-1 text-[10px] md:text-xs font-bold rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/40 group-hover:bg-cyan-500/40 transition leading-tight text-right">
                          {event.category}
                        </span>
                      </div>

                      {/* TITLE */}
                      <h3 className="text-lg md:text-xl font-bold text-white mb-3 group-hover:text-cyan-300 transition">
                        {event.name}
                      </h3>

                      {/* DESCRIPTION */}
                      <p className="text-sm text-gray-400 group-hover:text-gray-300 line-clamp-2 transition">
                        {event.description}
                      </p>
                    </div>
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={() => openEventDetails(event)}
                      className="mt-4 inline-flex items-center gap-2 rounded-lg border border-cyan-400/60 bg-cyan-500/10 px-3 py-2 text-cyan-200 font-semibold text-xs hover:bg-cyan-500/20 transition"
                    >
        ...
        {selectedEvent && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="fixed inset-x-0 top-16 bottom-0 z-[70] bg-black/75 backdrop-blur-sm p-3 md:p-6 lg:p-8 flex items-start justify-center overflow-y-auto"
          ...
          >
            <motion.div
              ...
              className="relative my-0 w-full max-w-3xl max-h-[calc(100svh-6rem)] rounded-2xl border border-cyan-400/40 bg-[#020812] shadow-[0_0_50px_rgba(34,211,238,0.2)] overflow-hidden flex flex-col"
